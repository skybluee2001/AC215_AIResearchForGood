...
def rank_and_filter_documents(
    query, documents, project_id, location, model_endpoint, creds, top_k=15
):
    """
...
def main(query="How to educate communities on homelessness"):
    ...
    top_documents = rank_and_filter_documents(
        query, documents, PROJECT_ID, LOCATION, MODEL_ENDPOINT, creds, TOP_K
    )
